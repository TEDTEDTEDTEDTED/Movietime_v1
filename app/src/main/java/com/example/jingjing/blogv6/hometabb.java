...
class hometabb extends RelativeLayout {
    ...
    public hometabb(Context context) {
        ...
        addView(view02);
        mSearchView = (SearchView) findViewById(R.id.searchview_movielist1);
        ...
        //刷新
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.refresh_layout1);
    ...
    public void setSearchRecyclerview() {
        ...
        Query query = db.collection("MovieList1");
