...
class hometabc extends RelativeLayout {
    ...
    public hometabc(Context context) {
        ...
        addView(view02);
        mSearchView = (SearchView) findViewById(R.id.searchview_movielist2);
        ...
        //刷新
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.refresh_layout2);
    ...
    public void setSearchRecyclerview() {
        ...
        Query query = db.collection("MovieList2");
